...
# in the current directory.
print("#####Test malloc")
com = "gcc"+ " -L../ " + " -Wall -Wno-unused-result -o " + bin_folder + "test6" + " " + "test6.c" + " -lft_malloc"
cmd.call(com.split())
com = "./" + bin_folder + "test6"
output = cmd_output_only(com.split())
print(output)
